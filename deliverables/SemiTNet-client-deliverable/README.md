...
این دستور figureهای paper-style را در `outputs/paper_style/figures/` می‌سازد و فقط از خروجی measured و referenceهای paper استفاده می‌کند. هیچ training یا inference جدیدی اجرا نمی‌شود.
